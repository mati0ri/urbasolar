...
const centrales: Record<string, Centrale> = {
    ...
    C3583: {
        ...
        geojson: require("../centrales/C3583/C3583_Purgé.geojson"),
    ...
    //     geojson: require("../centrales/C1752/C1752_Purgé.geojson"),
    ...
    C2488: {
        name: "CS Pujaut (2488)",
        geojson: require("../centrales/C2488/C2488_Purgé.geojson"),
